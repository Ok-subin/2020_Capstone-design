...
class MLP_LBP:
                ...
                for j in range(1, len_y-1):  # (1, 19)
                    for i in range(1, len_x-1):  # (1, 24)
                        ...
                        if index_x == 0:
                            ...
                            ii = (index_x // len_x) * len_x + i

                        if index_y == 0:
                            jj = len_y + j
                        else:
                            jj = (index_y // len_y) * len_y + j
    ...
    def cut_img(self):
        ...
        for g in range(1, 6):
            ...
            for f in range(100, cut_size, 10):
                #print(img_add)
                #print(h)
                size = f
                box_info = []
                for y in range(0, h - size + 1, 50):  # 픽셀 이동 간격 50
    ...
    def write_bb(self, box_info, img, img_num):
        ...
        write_add = "C:/Users/Ok Subin/Desktop/result2/"
        write_add += str(img_num)
        write_add += ".jpg"
        cv2.imwrite(write_add, final_img)

    def return_weight(self):
        file_name = "C:/Users/Ok Subin/Desktop/result/weight3.txt"
